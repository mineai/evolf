from evolution.old.evaluation.evaluate_generation import EvaluateGeneration
from evolution.old.evaluation.evaluate_state_of_the_art import EvaluateStateOfTheArt
from evolution.old.initialize_next_gen import InitializeNextGen
