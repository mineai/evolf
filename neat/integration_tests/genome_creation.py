...
from neat.network_constructor.network_constructor import \
    NetworkConstructor
from neat.reporduction.crossover.crossover import Crossover
from neat.reporduction.mutation.mutation import Mutation
from neat.visualize.visualize import Visualize
