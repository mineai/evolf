...
if __name__ == "__main__":
    # RUN: python3 -m string_evolve.domains.strevolve.ascii_neucleotide.server --config=string_evolve/domains/strevolve/config.hocon --target=string_evolve/domains/strevolve/target_coffee.txt
